(function($){
  ...
  // experement
  var sumscrollDown = new Function('a,b,c', 'return a>b&&a<c;');
  //var tempScrollTop = 0;
  var mHeight = $('.header-menu').outerHeight();
  $(document).scroll(function(){
    var st = $(this).scrollTop();
    var result0 = sumscrollDown(st, $('.contest').offset().top, $('[data-block="the-conference"]').offset().top-137);
    
    var result1 = sumscrollDown(st, $('[data-block="the-conference"]').offset().top-mHeight-88, $('[data-block="program"]').offset().top-100);
    var result2 = sumscrollDown(st, $('[data-block="program"]').offset().top-mHeight-88, $('[data-block="speakers"]').offset().top-100);
    var result3 = sumscrollDown(st, $('[data-block="speakers"]').offset().top-mHeight-88, $('[data-block="partners"]').offset().top-100);
    var result4 = sumscrollDown(st, $('[data-block="partners"]').offset().top-mHeight-88, $('[data-block="price"]').offset().top-100);
    var result5 = sumscrollDown(st, $('[data-block="price"]').offset().top-mHeight-88, $('[data-block="contacts"]').offset().top-100);
    var result6 = sumscrollDown(st, $('[data-block="contacts"]').offset().top-mHeight-88, $('[data-block="contacts"]').offset().top-100);

    (result0) ? $('[data-sname="home"]').addClass('active') : $('[data-sname="home"]').removeClass('active');
    (result1) ? $('[data-sname="the-conference"]').addClass('active') : $('[data-sname="the-conference"]').removeClass('active');
    (result2) ? $('[data-sname="program"]').addClass('active') : $('[data-sname="program"]').removeClass('active');
    (result3) ? $('[data-sname="speakers"]').addClass('active') : $('[data-sname="speakers"]').removeClass('active');
    (result4) ? $('[data-sname="partners"]').addClass('active') : $('[data-sname="partners"]').removeClass('active');
    (result5) ? $('[data-sname="price"]').addClass('active') : $('[data-sname="price"]').removeClass('active');
    (result6) ? $('[data-sname="contacts"]').addClass('active') : $('[data-sname="contacts"]').removeClass('active');
  });
  // end experement
  ...
  function countdownRun() {
    var whereToInsert = document.getElementsByClassName('cont')[0];
